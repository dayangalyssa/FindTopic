...
with open("data_api/data_clean/data_clean.json", "r") as f:
...
tfidf_df.to_csv("data_api/tfidf_results.csv", index=False)

print("\nHasil TF-IDF telah disimpan ke 'data_api/tfidf_results.csv'.")
